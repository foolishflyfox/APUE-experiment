...
void my_cond_wait(pthread_mutex_t* cond, pthread_mutex_t* mutex){
    pthread_mutex_unlock(mutex);
    pthread_mutex_lock(cond);
    pthread_mutex_lock(mutex);
}
void my_cond_signal(pthread_mutex_t* cond){
